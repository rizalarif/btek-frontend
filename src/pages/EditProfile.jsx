  ...
  return (
    ...
    <div className="navbar bg-base-100">
      ...
      <div className="navbar-center">
        <a href='https://reactjs.org/' className="btn btn-ghost normal-case text-xl">EDIT PROFILE</a>
      </div>
      ...
      >
        {({ errors, touched }) => (
          <Form className='mt-10'>
            ...
            <Field type="text" name="fullName" className="input input-bordered w-full max-w-xs hover:input-primary" />
            <br />
            ...
            <button type="submit" className='btn mt-5 mb-12 btn-primary block w-full'>Save</button>
          </Form>
        )}
      </Formik>
    </div>
